...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['razorpay_payment_id'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO orders (user_id, course_id, amount, status, razorpay_order_id) VALUES (?, ?, ?, 'success', ?)");
...
<div class="px-4 py-8">
    <div class="bg-white border rounded-lg p-5 mb-6 shadow-sm">
        ...
        <div class="flex gap-4 mb-4 items-center">
            ...
            <?php else: ?>
                <div class="w-28 aspect-video bg-gray-200 flex items-center justify-center rounded border"><i class="fas fa-image text-gray-400 text-2xl"></i></div>
            <?php endif; ?>
            <div class="flex-1">
                <p class="font-bold text-gray-800 text-sm md:text-base line-clamp-2"><?php echo htmlspecialchars($course['title']); ?></p>
                <div class="text-xs text-gray-500 mt-1 uppercase font-bold text-primary tracking-wide">Paid Course</div>
            </div>
        </div>
